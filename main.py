...
async def send_anekdot(update: Update, context):
    ...
    response = client.chat.completions.create(
        model="gpt-4",
        messages=[{"role": "user", "content": "Придумай короткий жарт або анекдот, включаючи одного або кількох з таких персонажів: Даня(найсмішніший), Віка (яка закохана в Нікіту, вона психолог), Діма(дуже сатирична особа), Нікіта(Він гей,який не ходить на навчання, постійно шукає відмазки), Нестор(спокійний), і Ананас(його звати Анас, він араб). Жарт має бути веселим і креативним, але не обов'язково всі персонажі повинні бути в кожному жарті, стеж за тим щоб анекдот був завершений і смішний."}],
    )
