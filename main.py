...
async def send_anekdot(update: Update, context):
    ...
    response = client.chat.completions.create(
        model="gpt-4",
        messages=[{"role": "user", "content": "Придумай короткий жарт або анекдот, включаючи одного або кількох з таких персонажів: Даня, Віка (яка закохана в Нікіту), Діма, Нікіта, Нестор, і Ананас. Жарт має бути веселим і креативним, але не обов'язково всі персонажі повинні бути в кожному жарті."}],
    )
